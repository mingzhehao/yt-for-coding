...
<li class="media" data-key="282">
    ...
    <div class="pull-right">
        <a class="views" href="/humour/view?id=<?php echo $model->id; ?>">浏览<em><?php echo $model->viewcount;?></em></a>
        <a class="answers" href="/question/282">回答<em>1</em></a>
    </div>
    <div class="media-body">
        <h2 class="media-heading">
            <span class="glyphicon glyphicon-question-sign"></span> 
            <a href="/humour/view?id=<?php echo $model->id; ?>"><?= Html::encode("$model->title");?></a>
            <small>[ 悬赏分：0 ]</small>
        </h2>
